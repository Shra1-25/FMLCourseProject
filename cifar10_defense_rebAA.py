...
import os
from SelfSupDefense.learning.wideresnet import WRN34_out_branch
from SelfSupDefense.learning.wideresnet import WideResNet, WideResNetBD, WideResNetMed_SSL, WRN34_out_branch
from CIFAR.model.wide_resnet import *
from SelfSupDefense.learning.preactresnet import PreActResNet18Mhead, Res18_out3_model,Res18_out4_model,Res18_out5_model,Res18_out6_model
from SelfSupDefense.gaussian_blur import GaussianLayer

from SelfSupDefense.utils import *
...
def main():
    ...
    args.fname = os.path.join(args.save_root_path, args.fname, timestamp + unique_str)
    args.fname = 'test'
    args.md_path = '/scratch/ssc10020/FML/Double-Win-Quant-main/CIFAR/pretrainedModels/model_wide_cifar10.pth'
    args.carmon = True
    args.eval_only = True
    args.ssl_model_path = './SelfSupDefense/ssl_model_130.pth'
    ...
    from CIFAR.utils import (upper_limit, lower_limit, std, mu, clamp, get_loaders,
    attack_pgd, evaluate_pgd, evaluate_standard)
    from CIFAR.model.wide_resnet import WideResNet32
    from CIFAR.model.preact_resnet import PreActResNet18
    ...
    pretrained_model = torch.load("CIFAR/pretrainedModels/model_wide_cifar10.pth")
    ...
    #     transforms.Normalize(cifar10_mean, cifar10_std),
    # ])
    scripted_transforms = torch.jit.script(transforms) # test_transform # 
    ...
    from SelfSupDefense.AAattack.autoattack import AutoAttack
